...
quiz_prompt = PromptTemplate(
    ...
    Выведи результат в виде JSON с полями: topic (передаваемая тема), question (вопрос), options (4 варианта ответов), correct_answer (правильный ответ) и key_words (ключевые слова).""",
)
