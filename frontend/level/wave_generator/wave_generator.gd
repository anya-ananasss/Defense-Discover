...
var level = 1
var power = 1150
var power_per_level = 225  # Увеличиваем базовую мощность врагов с каждым уровнем было 200
...
var short_range_max = 1.35  # Максимальная задержка
var long_range_min = 1.25
var long_range_max = 1.65
